...
if (bomba == 'não funciona') {
...
else if (bomba == 'funciona'){
    console.log('Enterga.')
}
else if (bomba == 'motor') {
    console.log('Enrrolar motor')
} 
    ...
    if (bomba == 'eixo enferrujado') {
        console.log('Encamizar eixo.')
    } 
    ...
    else if (bomba == 'cesto quebrado') {
        console.log('Trocar cesto coletor.')
    }
}
